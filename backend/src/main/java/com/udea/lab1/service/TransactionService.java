...
import com.udea.lab1.repository.TransactionRepository;
...
public class TransactionService {
    ...
    public List<TransactionDTO> getTransactionsForAccount(String accountNumber) {
        List<Transaction> transactions = transactionRepository.findAllBySenderAccountNumberOrReceiverAccountNumber(accountNumber,accountNumber);
